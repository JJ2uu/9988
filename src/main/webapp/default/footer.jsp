...
<div id="footer">
	<div style="width: 100%; padding: 10px 100px; border-bottom: 1px solid #e0e6ec; ">
		<ul class="footer_menu">
			...
			<li class="service"><a href="${pageContext.request.contextPath}/service/privacy.jsp">개인정보처리방침</a></li>
			<li style="color: #e0e6ec;">|</li>
	...
	<div style="font-size: 12px; display: flex; gap: 40px; align-items: flex-start; padding: 0 100px 50px 100px;">
		...
		<div style="display: flex; flex-flow: column; gap: 20px;">
			<div style="display:flex; flex-flow: column; text-align: left;">
				<span>(주) 9988 [99세까지 88하게 살자]</span>
				<span>Fax : (02)1234. 1234</span>
				<span>Email : triplej9988@gmail.com</span>
			</div>
			<div style="display: flex; flex-flow: column; text-align: left;">
				<span style="color: #99A3AD;">9988의 콘텐츠 및 기사는 저작권법의 보호를 받으므로, 무단 전재, 복사, 배포 등을 금합니다.</span>
				<span style="color: #99A3AD;">Copyright ⓒ 2023 (주)9988 All Rights Reserved.</span>
			</div>
		</div>
	</div>
</div>